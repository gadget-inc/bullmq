...
import { array2obj, clientCommandMessageReg, DELAY_TIME_5, delay, isNotConnectionError, isRedisInstance, QUEUE_SCHEDULER_SUFFIX, } from '../utils';
    ...
    async readDelayedData(client, key, streamLastId, blockTime) {
        if (!this.closing) {
            ...
            if (blockTime) {
                ...
                data = await this.checkConnectionError(() => client.xread('STREAMS', key, streamLastId));
            }
