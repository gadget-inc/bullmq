...
class Queue extends queue_getters_1.QueueGetters {
    constructor(name, opts, Connection) {
        super(name, Object.assign({ sharedConnection: utils_1.isRedisInstance(opts === null || opts === void 0 ? void 0 : opts.connection), blockingConnection: false }, opts), Connection);
